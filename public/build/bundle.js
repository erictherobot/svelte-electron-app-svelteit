...
var app = (function () {
    ...
    /* node_modules/@colorfuldots/svelteit/src/Button.svelte generated by Svelte v3.20.1 */
    ...
    function fallback_block(ctx) {
    	...
    	const block_1 = {
    		c: function create() {
    			...
    			add_location(em, file, 354, 6, 12869);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block_1 = {
    		c: function create() {
    			...
    			add_location(button, file, 329, 0, 12502);
    		},
    ...
    // (31:2) <Button on:click={() => counter++} primary outlined rounded>
    function create_default_slot(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Let's Svelteit!");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(31:2) <Button on:click={() => counter++} primary outlined rounded>",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 29, 2, 417);
    			add_location(p, file$1, 33, 2, 537);
    			attr_dev(main, "class", "svelte-1e9puaw");
    			add_location(main, file$1, 28, 0, 408);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*counter*/ 1) set_data_dev(t6, /*counter*/ ctx[0]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => $$invalidate(0, counter++, counter);
    	...
    	$$self.$capture_state = () => ({ Button, name, counter });
    	...
    	return [counter, name, click_handler];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { name: 1, counter: 0 });
